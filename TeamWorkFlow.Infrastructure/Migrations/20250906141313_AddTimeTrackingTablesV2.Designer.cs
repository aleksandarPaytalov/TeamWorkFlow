...
namespace TeamWorkFlow.Infrastructure.Migrations
{
    ...
    [Migration("20250906141313_AddTimeTrackingTablesV2")]
    partial class AddTimeTrackingTablesV2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "6473961e-64b2-4948-88c9-4f4160b5f66e",
                            Email = "guest@test.local",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedEmail = "GUEST@TEST.LOCAL",
                            NormalizedUserName = "GUEST@TEST.LOCAL",
                            PasswordHash = "AQAAAAEAACcQAAAAEPwKMH+B2ooDYrLV/duqz793jklozzTl41zMvHiJGWuYhhs81xgIpxfFPWYnGjFlCg==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "6cacd335-6b2c-4e91-8172-660e7e8b3008",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "c6c43743-a77b-454d-95fd-fb5d092b1383",
                            Email = "operator@test.local",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedEmail = "OPERATOR@TEST.LOCAL",
                            NormalizedUserName = "OPERATOR@TEST.LOCAL",
                            PasswordHash = "AQAAAAEAACcQAAAAEEyT150B0qFgVHfJz3POdQx+U4OMorxfc7fgpPwj1axnpte6FVECovBB+z+hkRpqGA==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "cf173120-fb95-4ae5-a3f1-70f5c223bb87",
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "7e33335c-9d7f-45ea-9716-d8f25b868d5e",
                            Email = "admin@test.local",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedEmail = "ADMIN@TEST.LOCAL",
                            NormalizedUserName = "ADMIN@TEST.LOCAL",
                            PasswordHash = "AQAAAAEAACcQAAAAEJd31KmVpg7bO25eqEcrZoDHL58MQ9PeapB0fKVP44bltBWx/Enw+1KJ+Jmfm2lSeA==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "383e2e0a-b81b-4628-91af-5ed197cbca3e",
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("TeamWorkFlow.Infrastructure.Data.Models.AdminDemotionRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TeamWorkFlow.Infrastructure.Data.Models.Task", b =>
                {
                    ...
                    b.Property<double?>("ActualTime")
                        .HasColumnType("float")
                        .HasComment("Actual time spent on the task in hours (calculated from start and end dates)");
                    ...
                    b.Property<string>("CompletedById")
                        .HasMaxLength(450)
                        .HasColumnType("nvarchar(450)")
                        .HasComment("User identifier who completed the task");
                    ...
                    b.Property<bool>("IsInSprint")
                        .HasColumnType("bit")
                        .HasComment("Indicates if task is included in current sprint");
                    ...
                    b.Property<DateTime?>("PlannedEndDate")
                        .HasColumnType("datetime2")
                        .HasComment("Planned completion date in sprint");

                    b.Property<DateTime?>("PlannedStartDate")
                        .HasColumnType("datetime2")
                        .HasComment("Planned start date in sprint");
                    ...
                    b.Property<int>("SprintOrder")
                        .HasColumnType("int")
                        .HasComment("Order position in sprint for drag-and-drop functionality");
            ...
            modelBuilder.Entity("TeamWorkFlow.Infrastructure.Data.Models.Task", b =>
                {
                    b.HasOne("Microsoft.AspNetCore.Identity.IdentityUser", "CompletedBy")
                        .WithMany()
